...
class ControllerCommonMenu extends Controller {
	public function index() {
		...
		$data['text_preports'] = $this->language->get('text_preports');
		$data['text_dreports'] = $this->language->get('text_dreports');
		...
		$data['preports'] = $this->url->link('sale/photos', 'token=' . $this->session->data['token'], 'SSL');
		$data['dreports'] = $this->url->link('sale/documents', 'token=' . $this->session->data['token'], 'SSL');
