   ...
   <?php } ?>
    ...
    <tr>
     ...
     <td class="left">
      ...
      <input type="text" name="ascp_widgets[<?php echo $list_num; ?>][avatar][height]" value="<?php if (isset($list['avatar']['height'])) echo $list['avatar']['height']; ?>" size="3" />
              ...
              <td><select name="ascp_widgets[<?php echo $list_num; ?>][thumb_status]">
	...
	<tr>
		    ...
		    <tr>
		     ...
		     <td class="left">
		      <textarea style="width: 96%; height: 160px;" name="ascp_widgets[<?php echo $list_num; ?>][anchor]" id="ascp_widgets_<?php echo $list_num; ?>_anchor"><?php  if (isset($list['anchor'])) echo $list['anchor']; ?></textarea>
          ...
          <tr>
              ...
              <td><select name="ascp_widgets[<?php echo $list_num; ?>][counting]">
