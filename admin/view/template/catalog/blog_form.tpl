        ...
        <div id="tab-general">
          ...
          <div id="language<?php echo $lang['language_id']; ?>">
            ...
            <tr>
              ...
              <td><input type="text" id="category_seo_url_<?php echo $lang['language_id']; ?>" name="keyword[<?php echo $lang['language_id']; ?>]" value="<?php if (isset($keyword[$lang['language_id']])) echo $keyword[$lang['language_id']]; ?>" size="50"/></td>
            </tr>
...
<script type="text/javascript">
<?php foreach ($languages as $lang) { ?>
$('#input-description<?php echo $lang['language_id']; ?>').summernote({
	height: 300
});
<?php } ?>
</script>
