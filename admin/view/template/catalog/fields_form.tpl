         ...
         if (isset($field_description[$lang['language_id']]['field'])) {
          ...
          <div id="language<?php echo $lang['language_id']; ?>">
            <table class="form">
              ...
              <tr>
                <td><?php echo $language->get('entry_field_class'); ?></td>
                <td><input type="text" name="fields_description[<?php echo $lang['language_id']; ?>][field][field_class]" id="field_class<?php echo $lang['language_id']; ?>" value="<?php echo isset($field_description[$lang['language_id']]['field']['field_class']) ? $field_description[$lang['language_id']]['field']['field_class'] : ''; ?>" size="20"/></td>
              </tr>
