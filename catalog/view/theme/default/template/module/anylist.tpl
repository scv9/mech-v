		...
		<?php foreach ($products as $product) { ?>
			  <div class="AnyListDiv">
			    <div class="product-thumb transition">
                    ...
                    <div>
                        <div class="caption">
                            <h4 style="height: 50px; overflow: hidden;"><a href="<?php echo $product['href']; ?>"><?php echo $product['name']; ?></a></h4>
                        ...
                        <div class="button-group">
                            <button class="btn-primary btn-xs" type="button" onclick="cart.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-shopping-cart"></i> <span class="hidden-xs hidden-sm hidden-md"><?php echo $button_cart; ?></span></button>
				...
				$('.AnyListDiv').each( 
					function(index) {
						...
						if (($(this).closest('#column-right').length==0) && ($(this).closest('#column-left').length==0)) { // if we are in content area check the layout
							...
							if (cols==0) 
								divclass = 'col-lg-2 col-md-3 col-sm-3 col-xs-12';	
						}
