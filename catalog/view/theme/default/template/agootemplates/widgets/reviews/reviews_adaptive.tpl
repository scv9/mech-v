...
<?php echo $box_begin; ?>
 ...
 <div class="divider100 margintop2"></div>
					...
					<a href="<?php echo $comment['record_href']; ?>#commentlink_<?php  echo $comment['comment_id']; ?>_<?php  echo $comment['cmswidget']; ?>" class="blog_further"><?php if (isset($settings_general['further'][$config_language_id])) echo html_entity_decode($settings_general['further'][$config_language_id]); ?></a>
				</div>
