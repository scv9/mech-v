		...
		?>
				...
				<div class="dropdown-menu">
					...
					<ul class="list-unstyled">
						...
						if ($rec_id) {
							 ...
							 ?>
							 <li>
								<a href="<?php echo $record['href']; ?>" class="blog-title  <?php if ($record['active']) echo 'active'; if (!$record['active'])	echo 'pass'; ?>"><?php echo $record['name']; ?></a>
			...
			<div class="content-records column_width_<?php echo $cmswidget; ?>">
                   ...
                   <?php if ((isset ($settings_widget['images_view']) && $settings_widget['images_view'])  || (isset($settings_widget['avatar_status']) && $settings_widget['avatar_status'])) { ?>
					...
					<div class="description record_description"><?php echo $record['description']; ?>&nbsp;<a href="<?php echo $record['href']; ?>" class="blog_further modal_<?php echo $cmswidget; ?>"><?php if (isset($settings_general['further'][$config_language_id])) echo html_entity_decode($settings_general['further'][$config_language_id]); ?></a></div>
                    <?php } ?>
